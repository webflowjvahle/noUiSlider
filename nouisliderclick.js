// noUislider
let targetNodeNoUiSlider = document.querySelector(".c-main");

let configNoUiSlider = { childList: true };

let callbackNoUiSlider = function (mutationsList) {
  for (let mutation of mutationsList) {
    if (mutation.type === "childList") {
      console.log("A child node has been added or removed.");
      if (document.querySelector("[data-nouislider]")) {
        console.log("navLinkNoUiSlider element is present on the page");
...
let observerNoUiSlider = new MutationObserver(callbackNoUiSlider);
observerNoUiSlider.observe(targetNodeNoUiSlider, configNoUiSlider);
